...
export const PlannerColumn = ({ children, counter, name, color, showAddButton, handleAddTask, handleMouseDown, id, className = "" }: PlannerColumnProps) => {
    ...
    return (
        <section ref={ref} className={`flex w-72 shrink-0 flex-col gap-2 rounded-lg p-4 ${sectionColorClass} ${isDropTarget ? "border-2 border-opacity-50 border-white" : " border-2 border-transparent"} ${className}`}>
